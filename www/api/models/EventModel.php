...
class EventModel extends ApplicationModel {
  ...
  /**
	 * Set event atribute into planetModel
	 * @param [type] $attr  [attribute you need]
	 * @param [type] $value [value you wanna push into eventModel]
	 */
  ...
  /**
	 * Get event attribut from data base
	 * @param  [type] $attr [attribut you wanna know]
	 * @return [type]       [value of the attribut from eventModel]
	 */
