...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`PLANET` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`ROLE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`AVATAR` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`BADGE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`RIDDLE_TYPE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`RIDDLE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`EVENT` ;
...
CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`EVENT` (
  ...
  PRIMARY KEY (`id`, `riddleId`),
  INDEX `fk_EVENT_RIDDLE1_idx` (`riddleId` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`RIDDLEPHASE` ;
...
CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`RIDDLEPHASE` (
  ...
  INDEX `fk_RIDDLEPHASE_RIDDLE1_idx` (`riddleId` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`SMILEY` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`INTEREST` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`INTEREST` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(45) NOT NULL,
  `initInterest` TINYINT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`IMGUPLOAD` ;
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`PUBLICATION_TYPE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`PUBLICATION_TYPE` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`PUBLICATION_TYPE` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`PUBLICATION` ;
...
CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`PUBLICATION` (
  ...
  `userId` INT NOT NULL,
  `imageUploadId` INT NULL,
  `publicationTypeId` INT NOT NULL,
  PRIMARY KEY (`id`, `userId`, `publicationTypeId`),
  INDEX `fk_POST_USER1_idx` (`userId` ASC),
  INDEX `fk_PUBLICATION_IMGUPLOAD1_idx` (`imageUploadId` ASC),
  INDEX `fk_PUBLICATION_PUBLICATION_TYPE1_idx` (`publicationTypeId` ASC),
  ...
  CONSTRAINT `fk_PUBLICATION_PUBLICATION_TYPE1`
    ...
    REFERENCES `friendshipTroopers`.`PUBLICATION_TYPE` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_INTEREST` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_SMILEY` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`USER_SMILEY` (
  `userId` INT NOT NULL,
  `smileyId` INT NOT NULL,
  `lastUseDate` DATETIME NULL,
  `obtentionDate` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_AVATAR` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`USER_AVATAR` (
  `userId` INT NOT NULL,
  `avatarId` INT NOT NULL,
  `currentAvatar` TINYINT NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_BADGE` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_RIDDLE` ;
...
CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`USER_RIDDLE` (
  ...
  `current` TINYINT NULL DEFAULT 1,
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`STARDUST`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`STARDUST` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`STARDUST` (
  `userId` INT NOT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`COMMENT` ;
...
CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`COMMENT` (
  ...
  `userId` INT NOT NULL,
  `publicationId` INT NOT NULL,
  `publishDate` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `modified` TINYINT NULL,
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`REPORT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`REPORT` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`REPORT` (
  `publicationId` INT NOT NULL,
  `userId` INT NOT NULL,
  INDEX `fk_SIGNALEMENT_PUBLICATION1_idx` (`publicationId` ASC),
  INDEX `fk_SIGNALEMENT_USER1_idx` (`userId` ASC),
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`CHATBOX`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`CHATBOX` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`CHATBOX` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`PREFERENCE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`PREFERENCE` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`PREFERENCE` (
  `id` INT NOT NULL,
  `label` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`USER_PREFERENCE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_PREFERENCE` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`USER_PREFERENCE` (
  `preferenceId` INT NOT NULL,
  `userId` INT NOT NULL,
  `status` TINYINT NOT NULL,
  PRIMARY KEY (`preferenceId`, `userId`),
  INDEX `fk_PREFERENCE_has_USER_USER1_idx` (`userId` ASC),
  INDEX `fk_PREFERENCE_has_USER_PREFERENCE1_idx` (`preferenceId` ASC),
  CONSTRAINT `fk_PREFERENCE_has_USER_PREFERENCE1`
    FOREIGN KEY (`preferenceId`)
    REFERENCES `friendshipTroopers`.`PREFERENCE` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PREFERENCE_has_USER_USER1`
    FOREIGN KEY (`userId`)
    REFERENCES `friendshipTroopers`.`USER` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`FRIEND`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`FRIEND` ;
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`TITLE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`TITLE` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`TITLE` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`USER_TITLE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`USER_TITLE` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`USER_TITLE` (
  `titleId` INT NOT NULL,
  `UserId` INT NOT NULL,
  `current` TINYINT NOT NULL DEFAULT 0,
  `obtentionDate` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`titleId`, `UserId`),
  INDEX `fk_TITLE_has_USER_USER1_idx` (`UserId` ASC),
  INDEX `fk_TITLE_has_USER_TITLE1_idx` (`titleId` ASC),
  CONSTRAINT `fk_TITLE_has_USER_TITLE1`
    FOREIGN KEY (`titleId`)
    REFERENCES `friendshipTroopers`.`TITLE` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TITLE_has_USER_USER1`
    FOREIGN KEY (`UserId`)
    REFERENCES `friendshipTroopers`.`USER` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`CHATBOX_PUBLICATION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`CHATBOX_PUBLICATION` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`CHATBOX_PUBLICATION` (
  `chatboxId` INT NOT NULL,
  `publicationId` INT NOT NULL,
  PRIMARY KEY (`chatboxId`, `publicationId`),
  INDEX `fk_CHATBOX_has_PUBLICATION_PUBLICATION1_idx` (`publicationId` ASC),
  INDEX `fk_CHATBOX_has_PUBLICATION_CHATBOX1_idx` (`chatboxId` ASC),
  CONSTRAINT `fk_CHATBOX_has_PUBLICATION_CHATBOX1`
    FOREIGN KEY (`chatboxId`)
    REFERENCES `friendshipTroopers`.`CHATBOX` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CHATBOX_has_PUBLICATION_PUBLICATION1`
    FOREIGN KEY (`publicationId`)
    REFERENCES `friendshipTroopers`.`PUBLICATION` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `friendshipTroopers`.`CHATBOX_USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `friendshipTroopers`.`CHATBOX_USER` ;

CREATE TABLE IF NOT EXISTS `friendshipTroopers`.`CHATBOX_USER` (
  `chatboxId` INT NOT NULL,
  `userId` INT NOT NULL,
  PRIMARY KEY (`chatboxId`, `userId`),
  INDEX `fk_CHATBOX_has_USER_USER1_idx` (`userId` ASC),
  INDEX `fk_CHATBOX_has_USER_CHATBOX1_idx` (`chatboxId` ASC),
  CONSTRAINT `fk_CHATBOX_has_USER_CHATBOX1`
    FOREIGN KEY (`chatboxId`)
    REFERENCES `friendshipTroopers`.`CHATBOX` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CHATBOX_has_USER_USER1`
    FOREIGN KEY (`userId`)
    REFERENCES `friendshipTroopers`.`USER` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
